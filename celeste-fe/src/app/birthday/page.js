...
export default function Home() {
  ...
  return (
    <main>
      <div className='flex h-screen bg-fixed bg-cover bg-center items-center justify-center' style={{ backgroundImage: `url('${Cover5.src}')` }}>
        <div className='bg-neutral-900/75 rounded-lg px-10 py-5 text-4xl text-[#F397AF]'>Төрсөн өдөр</div>
      </div>
